...
export default function NIRF2025Page() {
  const pdfUrl = "/legacy/pdfs/nirfbvimit2025.pdf";
        ...
        <section className="relative overflow-hidden bg-[#111827] py-16 md:py-20">
          ...
          <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 max-w-2xl text-sm font-semibold text-slate-300 leading-relaxed">
              Official institutional disclosure data submitted for the 2025 National Institutional Ranking Framework cycle.
            </p>
          </div>
        </section>
              ...
              >
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-xs font-bold text-muted-foreground">
                    ...
                    <span>Submission Year: 2025</span>
                  </div>
