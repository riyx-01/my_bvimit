...
export default function NIRF2024Page() {
  const pdfUrl = "/legacy/pdfs/bvimitnirf24.pdf";
        ...
        <section className="relative overflow-hidden bg-[#111827] py-16 md:py-20">
          ...
          <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <h1 className="max-w-4xl text-3xl font-black tracking-tight text-white md:text-5xl">
              NIRF 2024 Submission
            </h1>
            <p className="mt-4 max-w-2xl text-sm font-semibold text-slate-300 leading-relaxed">
              Official institutional disclosure data submitted for the 2024 National Institutional Ranking Framework cycle.
            </p>
          </div>
        </section>
              ...
              >
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-xs font-bold text-muted-foreground">
                    ...
                    <span>Submission Year: 2024</span>
                  </div>
